...
exports.createIntergration = function (hostFactory, topologyMap) {
    var logger = environment_1.EnvironmentObject.logger;
    var hosts = topologyMap.hosts, devices = topologyMap.devices;
    ...
    Promise.all(hosts.map(function (hostConfig) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, hostFactory(hostConfig).catch(function () {
                        throw Error("Failed to create Factory " + hostConfig.name + ")");
                    })];
                case 1:
                    host = _a.sent();
                    return [2 /*return*/, [hostConfig.name, host]];
            }
        });
    }); })).then(function (hostFactories) {
        logger.info("Host Factories: " + JSON.stringify(hostFactories, null, 2));
        // Combine returned device factories into indexed collection
        var deviceFactories = hostFactories.reduce(function (a, v) {
            var _a;
        ...
        deviceFactories[device.hostName][device.type](device).catch(function () {
